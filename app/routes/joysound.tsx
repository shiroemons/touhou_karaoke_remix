...
export const meta: MetaFunction = () => {
  return [
    { title: "東方カラオケ検索 JOYSOUND | 迷い家の白猫" },
    { name: "description", content: "JOYSOUNDで配信されている東方系楽曲を曲名・歌手名・サークル名・原曲名で検索することができます。" },
  ];
};
...
function Search({ serverState, serverUrl }: SearchProps) {
  return (
    <InstantSearchSSRProvider {...serverState}>
      ...
      >
        <SearchUI configureFilters="karaoke_type:'JOYSOUND'" />
      </InstantSearch>
    </InstantSearchSSRProvider>
  );
}

export default function JoysoundPage() {
